...
$file = "D:\laragon\www\HeroBiz-1.0.0\template_backup\index.html"
$out  = "D:\laragon\www\HeroBiz-1.0.0\resources\views\welcome.blade.php"
...
$header = '@extends(''layouts.app'')' + "`n`n" +
          '@section(''title'', ''Index - HeroBiz Bootstrap Template'')' + "`n`n" +
          '@section(''body_class'', ''index-page'')' + "`n`n" +
          '@section(''content'')' + "`n"
...
Write-Host "Done. Content lines: $($contentLines.Count)"
