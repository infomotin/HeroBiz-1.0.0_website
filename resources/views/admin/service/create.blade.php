    ...
    <form action="{{ route('admin.service.store') }}" method="POST">
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="link" value="{{ old('link') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
            </div>
