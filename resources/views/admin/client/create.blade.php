    ...
    <form action="{{ route('admin.client.store') }}" method="POST">
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="logo" value="{{ old('logo') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Website</label>
                <input type="text" name="website" value="{{ old('website') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
            </div>
        ...
        <div class="mt-4 space-x-2">
            ...
            <a href="{{ route('admin.client.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400">Cancel</a>
        </div>
    </form>
</div>
@endsection
