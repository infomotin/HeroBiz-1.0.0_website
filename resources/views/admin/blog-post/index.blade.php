        ...
        <tbody class="divide-y divide-gray-200">
            @forelse($posts as $post)
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500">{{ $post->published_at?->format('Y-m-d') ?? 'Draft' }}</td>
            ...
            @empty
                <tr><td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No blog posts found.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
