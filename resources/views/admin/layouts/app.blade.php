...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - HeroBiz</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <style>
        .sidebar { width: 250px; min-height: 100vh; }
        .sidebar-link { display: flex; align-items: center; padding: 0.5rem 1rem; border-radius: 0.375rem; color: #9ca3af; text-decoration: none; font-size: 0.875rem; transition: all 0.15s; }
        .sidebar-link:hover { background-color: #1f2937; color: #fff; }
        .sidebar-link.active { background-color: #3b82f6; color: #fff; }
        .sidebar-section { font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.05em; color: #6b7280; padding: 0.5rem 1rem 0.25rem; margin-top: 0.5rem; }
    </style>
</head>
    ...
    <div class="flex">
        ...
        <aside class="sidebar bg-gray-900 text-white flex-shrink-0">
            <div class="p-4 border-b border-gray-800">
                <a href="{{ route('admin.dashboard') }}" class="text-xl font-bold text-white">HeroBiz Admin</a>
            </div>
            <nav class="p-2 overflow-y-auto" style="max-height: calc(100vh - 65px);">
                ...
                <a href="{{ route('admin.about-section.index') }}" class="sidebar-link {{ request()->routeIs('admin.about-section.*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    About Section
                </a>
                <a href="{{ route('admin.about-tab.index') }}" class="sidebar-link {{ request()->routeIs('admin.about-tab.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.feature.index') }}" class="sidebar-link {{ request()->routeIs('admin.feature.*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                    Features
                </a>
                <a href="{{ route('admin.call-to-action.index') }}" class="sidebar-link {{ request()->routeIs('admin.call-to-action.*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122"></path></svg>
                    Call to Action
                </a>
                <a href="{{ route('admin.onfocus.index') }}" class="sidebar-link {{ request()->routeIs('admin.onfocus.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.service-detail.index') }}" class="sidebar-link {{ request()->routeIs('admin.service-detail.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.portfolio-category.index') }}" class="sidebar-link {{ request()->routeIs('admin.portfolio-category.*') ? 'active' : '' }}">
                ...
                <div class="sidebar-section">Team & Testimonials</div>
                ...
                <a href="{{ route('admin.blog-post.index') }}" class="sidebar-link {{ request()->routeIs('admin.blog-post.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.blog-category.index') }}" class="sidebar-link {{ request()->routeIs('admin.blog-category.*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                    Blog Categories
                </a>
                <a href="{{ route('admin.blog-tag.index') }}" class="sidebar-link {{ request()->routeIs('admin.blog-tag.*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                    Blog Tags
                </a>
                <a href="{{ route('admin.blog-author.index') }}" class="sidebar-link {{ request()->routeIs('admin.blog-author.*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    Blog Authors
                </a>
                <a href="{{ route('admin.blog-comment.index') }}" class="sidebar-link {{ request()->routeIs('admin.blog-comment.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.page.index') }}" class="sidebar-link {{ request()->routeIs('admin.page.*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    Pages
                </a>
                <a href="{{ route('admin.contact-message.index') }}" class="sidebar-link {{ request()->routeIs('admin.contact-message.*') ? 'active' : '' }}">
